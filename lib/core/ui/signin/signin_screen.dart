              ...
              child: Column(
                ...
                children: [
                 ...
                 const SizedBox(height: 8),
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const WebViewScreen(url: 'https://www.google.co.in/')));
                    },
                    child: Container(
                      height: 58,width: 311,
                      decoration: BoxDecoration(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const WebViewScreen(url: 'https://www.facebook.com/',)));
                    },
                    child: Container(
                      height: 58,width: 311,
                      decoration: BoxDecoration(
